...
class CourseNotFoundError(ResourceNotFoundError):
    ...
    def __init__(self, course_code: str, term_id: str, message=None):
        ...
        super().__init__(
            resource_type="Course", identifier=course_code, message=message
        )
...
class SectionNotFoundError(ResourceNotFoundError):
    ...
    def __init__(self, section_key: str, course_code: str, term_id: str, message=None):
        ...
        super().__init__(
            resource_type="Section", identifier=section_key, message=message
        )
...
class SeatsAlreadyOpenError(TimetableCheckerBaseError):
    ...
    def __init__(
        self, course_code: str, section_display: str, open_seats: int, message=None
    ):
        if message is None:
            message = (
                f"Cannot add watch: Section {section_display} for {course_code} "
...
class EmailRecipientInvalidError(NotificationSystemError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, original_exception=original_exception
        )  # <-- Pass it here
